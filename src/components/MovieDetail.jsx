                    ...
                    <div className="p-4 md:p-6 md:w-2/3">
                        ...
                        <div className="flex flex-wrap mb-4">
                            <div className="w-full md:w-1/2 mb-4 md:mb-0">
                                <h2 className="text-lg md:text-xl font-semibold">Director</h2>
                        ...
                        <div className="flex flex-wrap mb-4">
                            <div className="w-full md:w-1/2 mb-4 md:mb-0">
                                <h2 className="text-lg md:text-xl font-semibold">Awards</h2>
                                <p>{movieDetails.Awards}</p>
                            </div>
                            <div className="w-full md:w-1/2">
                                <h2 className="text-lg md:text-xl font-semibold">Box Office</h2>
                                <p>{movieDetails.BoxOffice}</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap mb-4">
                            <div className="w-full md:w-1/2 mb-4 md:mb-0">
                                <h2 className="text-lg md:text-xl font-semibold">IMDB Rating</h2>
                                <p>{movieDetails.imdbRating}</p>
                            </div>
                            <div className="w-full md:w-1/2">
                                <h2 className="text-lg md:text-xl font-semibold">IMDB Votes</h2>
                                <p>{movieDetails.imdbVotes}</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="w-full">
                                <h2 className="text-lg md:text-xl font-semibold">IMDB ID</h2>
                                <p>{imdbID}</p>
                            </div>
                        </div>
                    </div>
